          ...
          <div className="win-panel-inset" style={{ maxHeight: '600px', overflow: 'auto', width: '100%', boxSizing: 'border-box' }}>
            <table style={{ width: '100%', fontSize: '10px', fontFamily: "'Courier Prime', monospace" }}>
              ...
              <tbody>
                ...
                {filtered.map((d, i) => (
                  <tr key={d.id} style={{ backgroundColor: i % 2 === 0 ? 'hsl(220,15%,96%)' : 'hsl(220,20%,92%)', height: '24px', lineHeight: '24px' }}>
                    <td style={{ padding: '0 4px', fontWeight: 'bold' }}>{d.serial_number}</td>
