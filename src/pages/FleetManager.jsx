...
export default function FleetManager() {
  ...
  const handleExportMakeSummaryPDF = () => {
    exportFleetMakeSummaryPDF({ buses });
  };

  const handleExportPDF = () => {
    exportFleetPDF({ buses, title: 'FLEET INVENTORY REPORT — ENTIRE FLEET' });
  };

  const handleExportFilteredPDF = () => {
    exportFleetPDF({ buses: filtered, title: `FLEET INVENTORY REPORT — FILTERED (${filtered.length})` });
  };
