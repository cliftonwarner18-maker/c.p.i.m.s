    ...
    <>
      ...
      <div style={{display:'flex',flexDirection:'column',gap:'4px'}}>
       <div style={{display:'flex',flexDirection:'column',width:'100%',marginBottom:'16px'}}>
          <div style={{width:'100%',backgroundColor:'#1a3a6b',color:'white',padding:'8px 12px',display:'block',fontFamily:'monospace',fontSize:'12px',fontWeight:'bold'}}>
            ALL WORK ORDERS — SURVEILLANCE REPAIR LOG
          </div>
          <div style={{width:'100%',display:'block',padding:'8px'}}>
            {/* Filters */}
