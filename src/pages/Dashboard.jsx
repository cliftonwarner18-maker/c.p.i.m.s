...
const hdr = { background: 'linear-gradient(to right, hsl(220,50%,30%), hsl(220,45%,40%))', color: 'white', padding: '7px 12px', fontSize: '11px', fontWeight: '700', letterSpacing: '0.08em', fontFamily: FF };
const panel = { background: 'white', border: '1px solid hsl(220,18%,78%)', borderRadius: '2px', overflow: 'hidden', marginBottom: 0 };
...
export default function Dashboard() {
  ...
  const btnBase = { display: 'inline-flex', alignItems: 'center', gap: 6, padding: '7px 14px', fontSize: '11px', fontFamily: FF, fontWeight: '700', borderRadius: '2px', cursor: 'pointer', textDecoration: 'none', border: '1px solid' };
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', fontFamily: FF }}>
      ...
      <div style={{ display: 'flex', gap: '6px', flexWrap: 'wrap' }}>
        <Link to={createPageUrl('NewWorkOrder')} style={{ ...btnBase, background: 'hsl(140,55%,38%)', color: 'white', borderColor: 'hsl(140,55%,30%)' }}>
          <PlusCircle style={{ width: 13, height: 13 }} /> NEW WORK ORDER
        </Link>
        <Link to={createPageUrl('FleetManager')} style={{ ...btnBase, background: 'hsl(220,18%,88%)', color: 'hsl(220,20%,20%)', borderColor: 'hsl(220,18%,70%)' }}>
          <Bus style={{ width: 13, height: 13 }} /> MANAGE FLEET
        </Link>
        <Link to={createPageUrl('Inspections')} style={{ ...btnBase, background: 'hsl(220,18%,88%)', color: 'hsl(220,20%,20%)', borderColor: 'hsl(220,18%,70%)' }}>
          <ClipboardCheck style={{ width: 13, height: 13 }} /> INSPECTIONS
        </Link>
        <button onClick={() => setShowTranscribe(true)} style={{ ...btnBase, background: 'hsl(45,90%,50%)', color: 'hsl(220,20%,10%)', borderColor: 'hsl(45,90%,40%)' }}>
