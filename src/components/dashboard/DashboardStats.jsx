...
export default function DashboardStats({ buses, workOrders, inspections }) {
  ...
  return (
    <div style={{display:'flex',flexDirection:'row',width:'100%',maxWidth:'100%',margin:'0',padding:'8px',background:'hsl(220,20%,10%)',border:'2px solid hsl(220,70%,35%)',boxSizing:'border-box',gap:'4px'}}>
      {stats.map((stat, i) => (
        <div key={i} style={{flex:1,display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',textAlign:'center',padding:'16px 12px',background:'hsl(220,20%,8%)',border:'2px solid',borderColor:stat.color,boxShadow:`0 0 12px ${stat.color}40`,minHeight:'100px',boxSizing:'border-box'}}>
