...
export default function WinWindow({ title, children, className = "", icon = null, noPadding = false }) {
  return (
    <div className={`win-panel ${className}`} style={{display: 'flex', flexDirection: 'column', width: '100%', boxSizing: 'border-box'}}>
      <div className="win-titlebar flex items-center justify-between select-none" style={{padding: '2px 4px', gap: '2px', width: '100%', boxSizing: 'border-box'}}>
