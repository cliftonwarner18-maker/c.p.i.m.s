         ...
         <div style={{display:'flex',flexDirection:'column',width:'100%',marginBottom:'12px'}}>
           ...
           <div style={{display:'flex',flexDirection:'column',gap:'0',width:'100%'}}>
            ...
            <Field label="WHITE BOARD STATUS">
              <select className="win-input" style={{width:'100%',fontSize:'11px'}} value={form.board_status} onChange={e => setForm(prev => ({...prev, board_status: e.target.value}))}>
                <option value="Available">Available (Green)</option>
                <option value="Dead Line">Dead Line (Red)</option>
